...
public class LiftCmd3BarSibling extends SequentialCommandGroup {
  double standardDelay = 10;
  double pneumaticDelay = .1;

  public LiftCmd3BarSibling() {
        addCommands( 
          ...
          //new Timeout(.5), -sienna change to distance
          new ClimberCmd(ClimbMode.DISTANCE, 0.5, 6.0, standardDelay), 
          new ClimberCmd(ClimbMode.BAR_RELEASE_IN),
          ...
          new ClimberCmd(ClimbMode.BAR_RELEASE_IN),
          new Timeout(0.5),   
          new ClimberCmd(ClimbMode.DISTANCE,0.5, 3.0, standardDelay), 
          ...
          new DisplayLog("End Auto Climb 3 bar"),
